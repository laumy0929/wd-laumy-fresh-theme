...
<main class="main-container">
		...
		<div class="categories-card">
			...
			<ul class="categories-list">
				...
				<?php foreach ($cats as $cat): ?>
					<li class="category-item<?php if (single_cat_title('', false) === $cat['title']) echo ' expanded'; ?>">
	...
	<!-- Content Area: posts in this category -->
	<section class="content-area">
		<div class="posts-card">
			<div class="posts-header"><?php single_cat_title(); ?></div>
			<ul class="posts-list">
